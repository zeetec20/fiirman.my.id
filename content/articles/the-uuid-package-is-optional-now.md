...
excerpt: "Almost all of my projects use the uuid dependency. However, I recently realized that the dependency is no longer necessary if you’re only generating UUID v4. Both modern browsers and Node.js already p"
---
